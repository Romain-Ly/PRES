...
\def\nomEncad{S.~Secci,\\ Y.~Benchaïb, M.~Coudron}
...
%% Si le projet est encadré par moinde 4 étudiants laissez
...
\def\titreProjetLong{MPTCP\\Performances et optimisation de la
  sécurité avec un ordonnancement réparti dans les topologies
  virtualisées OpenFlow}
...
\include{corps}
\clearpage
\include{conclusions-perspectives}
\include{section/Annexe1}
...
\label{fin} %% Ne pas supprimer, nécessaire pour calculer le nombre de pages RL
\end{document}
